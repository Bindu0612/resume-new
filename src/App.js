        ...
        <div>
          {profile1.map(item => (
            <div>            
              ...
              <div>
                <span className="roleStyle"> {item.role} </span>
              </div>
              ...
              <div>
              <span className="keyStyle"> {item.key6} </span>
              </div>
              ...
              <div>
              <span className="keyStyle"> {item.key7} </span>
              </div>
              ...
              <div>
              <span className="keyStyle"> {item.key8} </span>
              </div>
